...
cors = CORS(app, supports_credentials=True, origins=['http://localhost:4887', 'http://127.0.0.1:8887', 'http://127.0.0.1:4887', 'http://127.0.0.1:4100', 'https://nighthawkcoders.github.io'])
